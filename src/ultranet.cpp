...
#pragma HLS STREAM variable = conv_0_out depth = 128 dim = 1
  conv3x3_bn_act<CONV_0_IFM_ROW, CONV_0_IFM_COL, CONV_0_IFM_CH, CONV_0_IN_BIT,
      ...
      in_stream2, conv_0_w, conv_0_inc, conv_0_bias, conv_0_out, reps);
#ifdef DEBUG
...
#pragma HLS STREAM variable = pool_0_out depth = 128 dim = 1
  max_pool2d<2, CONV_0_OFM_ROW, CONV_0_OFM_COL, CONV_0_OFM_CH, CONV_0_OUT_BIT>(
      conv_0_out, pool_0_out, reps);
#ifdef DEBUG
...
#pragma HLS STREAM variable = conv_1_out depth = 128 dim = 1
  conv3x3_bn_act<CONV_1_IFM_ROW, CONV_1_IFM_COL, CONV_1_IFM_CH, CONV_1_IN_BIT,
      ...
      pool_0_out, conv_1_w, conv_1_inc, conv_1_bias, conv_1_out, reps);
#ifdef DEBUG
...
#pragma HLS STREAM variable = pool_1_out depth = 128 dim = 1
  max_pool2d<2, CONV_1_OFM_ROW, CONV_1_OFM_COL, CONV_1_OFM_CH, CONV_1_OUT_BIT>(
      conv_1_out, pool_1_out, reps);
#ifdef DEBUG
...
#pragma HLS STREAM variable = conv_2_out depth = 128 dim = 1
  conv3x3_bn_act<CONV_2_IFM_ROW, CONV_2_IFM_COL, CONV_2_IFM_CH, CONV_2_IN_BIT,
      ...
      pool_1_out, conv_2_w, conv_2_inc, conv_2_bias, conv_2_out, reps);
#ifdef DEBUG
...
#pragma HLS STREAM variable = pool_2_out depth = 128 dim = 1
  max_pool2d<2, CONV_2_OFM_ROW, CONV_2_OFM_COL, CONV_2_OFM_CH, CONV_2_OUT_BIT>(
      conv_2_out, pool_2_out, reps);
#ifdef DEBUG
...
#pragma HLS STREAM variable = conv_3_out depth = 128 dim = 1
  conv3x3_bn_act<CONV_3_IFM_ROW, CONV_3_IFM_COL, CONV_3_IFM_CH, CONV_3_IN_BIT,

                 CONV_3_OFM_CH, CONV_3_OUT_BIT,

                 CONV_3_W_BIT, 32, CONV_3_INC_BIT, CONV_3_BIAS_BIT,

                 CONV_3_SIMD, CONV_3_PE, CONV_3_L_SHIFT>(
      pool_2_out, conv_3_w, conv_3_inc, conv_3_bias, conv_3_out, reps);
#ifdef DEBUG
...
#pragma HLS STREAM variable = pool_3_out depth = 128 dim = 1
  max_pool2d<2, CONV_3_OFM_ROW, CONV_3_OFM_COL, CONV_3_OFM_CH, CONV_3_OUT_BIT>(
      conv_3_out, pool_3_out, reps);
#ifdef DEBUG
...
#pragma HLS STREAM variable = conv_4_out depth = 128 dim = 1
  conv3x3_bn_act<CONV_4_IFM_ROW, CONV_4_IFM_COL, CONV_4_IFM_CH, CONV_4_IN_BIT,

                 CONV_4_OFM_CH, CONV_4_OUT_BIT,

                 CONV_4_W_BIT, 32, CONV_4_INC_BIT, CONV_4_BIAS_BIT,

                 CONV_4_SIMD, CONV_4_PE, CONV_4_L_SHIFT>(
      pool_3_out, conv_4_w, conv_4_inc, conv_4_bias, conv_4_out, reps);
#ifdef DEBUG
...
#pragma HLS STREAM variable = conv_5_out depth = 128 dim = 1
  conv3x3_bn_act<CONV_5_IFM_ROW, CONV_5_IFM_COL, CONV_5_IFM_CH, CONV_5_IN_BIT,
      ...
      conv_4_out, conv_5_w, conv_5_inc, conv_5_bias, conv_5_out, reps);
#ifdef DEBUG
...
#pragma HLS STREAM variable = conv_6_out depth = 128 dim = 1
  conv3x3_bn_act<CONV_6_IFM_ROW, CONV_6_IFM_COL, CONV_6_IFM_CH, CONV_6_IN_BIT,

                 CONV_6_OFM_CH, CONV_6_OUT_BIT,

                 CONV_6_W_BIT, 32, CONV_6_INC_BIT, CONV_6_BIAS_BIT,

                 CONV_6_SIMD, CONV_6_PE, CONV_6_L_SHIFT>(
      conv_5_out, conv_6_w, conv_6_inc, conv_6_bias, conv_6_out, reps);
#ifdef DEBUG
...
#pragma HLS STREAM variable = conv_7_out depth = 128 dim = 1
  conv3x3_bn_act<CONV_7_IFM_ROW, CONV_7_IFM_COL, CONV_7_IFM_CH, CONV_7_IN_BIT,
      ...
      conv_6_out, conv_7_w, conv_7_inc, conv_7_bias, conv_7_out, reps);
#ifdef DEBUG
...
#pragma HLS STREAM variable = conv_8_out depth = 64 dim = 1
  conv1x1<CONV_8_IFM_ROW, CONV_8_IFM_COL, CONV_8_IFM_CH, CONV_8_IN_BIT,
          ...
          CONV_8_SIMD, CONV_8_PE>(conv_8_in, conv_8_w, conv_8_out, reps);
#ifdef DEBUG
...
#pragma HLS STREAM variable = conv_1_out depth = 128 dim = 1
  conv3x3_bn_act_DSPopt<CONV_1_IFM_ROW, CONV_1_IFM_COL, CONV_1_IFM_CH,
                        ...
                        CONV_1_W_BIT, 16, CONV_1_INC_BIT, CONV_1_BIAS_BIT,
                        CONV_1_SIMD_DSP6, 4, CONV_1_INPE, CONV_1_PE_DSP6,
                        CONV_1_L_SHIFT>(pool_0_out, conv_1_w_dspopt,
                                        conv_1_inc_dspopt, conv_1_bias_dspopt,
                                        conv_1_out, reps);
#ifdef DEBUG
  cout << "conv_1_out size " << conv_1_out.size() << endl;
...
#pragma HLS STREAM variable = conv_2_out depth = 128 dim = 1
  conv3x3_bn_act_DSPopt<CONV_2_IFM_ROW, CONV_2_IFM_COL, CONV_2_IFM_CH,
                        ...
                        CONV_2_W_BIT, 17, CONV_2_INC_BIT, CONV_2_BIAS_BIT,
                        CONV_2_SIMD_DSP6, 4, CONV_2_INPE, CONV_2_PE_DSP6,
                        CONV_2_L_SHIFT>(pool_1_out, conv_2_w_dspopt,
                                        conv_2_inc_dspopt, conv_2_bias_dspopt,
                                        conv_2_out, reps);
#ifdef DEBUG
  cout << "conv_2_out size " << conv_2_out.size() << endl;
...
#pragma HLS STREAM variable = conv_3_out depth = 128 dim = 1
  conv3x3_bn_act_DSPopt<CONV_3_IFM_ROW, CONV_3_IFM_COL, CONV_3_IFM_CH,
                        ...
                        CONV_3_W_BIT, 18, CONV_3_INC_BIT, CONV_3_BIAS_BIT,
                        CONV_3_SIMD_DSP6, 4, CONV_3_INPE, CONV_3_PE_DSP6,
                        CONV_3_L_SHIFT>(pool_2_out, conv_3_w_dspopt,
                                        conv_3_inc_dspopt, conv_3_bias_dspopt,
                                        conv_3_out, reps);
#ifdef DEBUG
  cout << "conv_3_out size " << conv_3_out.size() << endl;
...
#pragma HLS STREAM variable = conv_4_out depth = 128 dim = 1
  conv3x3_bn_act_DSPopt<CONV_4_IFM_ROW, CONV_4_IFM_COL, CONV_4_IFM_CH,
                        ...
                        CONV_4_W_BIT, 18, CONV_4_INC_BIT, CONV_4_BIAS_BIT,
                        CONV_4_SIMD_DSP6, 4, CONV_4_INPE, CONV_4_PE_DSP6,
                        CONV_4_L_SHIFT>(pool_3_out, conv_4_w_dspopt,
                                        conv_4_inc_dspopt, conv_4_bias_dspopt,
                                        conv_4_out, reps);
#ifdef DEBUG
  cout << "conv_4_out size " << conv_4_out.size() << endl;
...
#pragma HLS STREAM variable = conv_5_out depth = 128 dim = 1
  conv3x3_bn_act_DSPopt<CONV_5_IFM_ROW, CONV_5_IFM_COL, CONV_5_IFM_CH,
                        ...
                        CONV_5_W_BIT, 18, CONV_5_INC_BIT, CONV_5_BIAS_BIT,
                        CONV_5_SIMD_DSP6, 4, CONV_5_INPE, CONV_5_PE_DSP6,
                        CONV_5_L_SHIFT>(conv_4_out, conv_5_w_dspopt,
                                        conv_5_inc_dspopt, conv_5_bias_dspopt,
                                        conv_5_out, reps);
#ifdef DEBUG
  cout << "conv_5_out size " << conv_5_out.size() << endl;
...
#pragma HLS STREAM variable = conv_6_out depth = 128 dim = 1
  conv3x3_bn_act_DSPopt<CONV_6_IFM_ROW, CONV_6_IFM_COL, CONV_6_IFM_CH,
                        ...
                        CONV_6_W_BIT, 18, CONV_6_INC_BIT, CONV_6_BIAS_BIT,
                        CONV_6_SIMD_DSP6, 4, CONV_6_INPE, CONV_6_PE_DSP6,
                        CONV_6_L_SHIFT>(conv_5_out, conv_6_w_dspopt,
                                        conv_6_inc_dspopt, conv_6_bias_dspopt,
                                        conv_6_out, reps);
#ifdef DEBUG
  cout << "conv_6_out size " << conv_6_out.size() << endl;
...
#pragma HLS STREAM variable = conv_7_out depth = 128 dim = 1
  conv3x3_bn_act_DSPopt<CONV_7_IFM_ROW, CONV_7_IFM_COL, CONV_7_IFM_CH,
                        ...
                        CONV_7_W_BIT, 18, CONV_7_INC_BIT, CONV_7_BIAS_BIT,
                        CONV_7_SIMD_DSP6, 4, CONV_7_INPE, CONV_7_PE_DSP6,
                        CONV_7_L_SHIFT>(conv_6_out, conv_7_w_dspopt,
                                        conv_7_inc_dspopt, conv_7_bias_dspopt,
                                        conv_7_out, reps);
#ifdef DEBUG
  cout << "conv_7_out size " << conv_7_out.size() << endl;
